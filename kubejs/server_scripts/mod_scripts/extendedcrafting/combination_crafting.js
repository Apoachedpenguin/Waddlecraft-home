onEvent('recipes', event => {
    ...
    event.custom({
        "type": "extendedcrafting:combination",
        "powerCost": 500000,
        "input": { "item": "gobber2:gobber2_helmet_end" },
        "ingredients": [
        ...
        "result": { "item": "gobber2:gobber2_helmet_dragon" }
    })
    event.custom({
        "type": "extendedcrafting:combination",
        "powerCost": 500000,
        "input": { "item": "gobber2:gobber2_chestplate_end" },
        "ingredients": [
        ...
        "result": { "item": "gobber2:gobber2_chestplate_dragon" }
    })
    event.custom({
        "type": "extendedcrafting:combination",
        "powerCost": 500000,
        "input": { "item": "gobber2:gobber2_leggings_end" },
        "ingredients": [
        ...
        "result": { "item": "gobber2:gobber2_leggings_dragon" }
    })
    event.custom({
        "type": "extendedcrafting:combination",
        "powerCost": 500000,
        "input": { "item": "gobber2:gobber2_boots_end" },
        "ingredients": [
        ...
        "result": { "item": "gobber2:gobber2_boots_dragon" }
    })
})
