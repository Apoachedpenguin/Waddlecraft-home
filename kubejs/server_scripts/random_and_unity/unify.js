...
let customtags = [
    ...
    ["cagedmobs:nether_star_fragment","silentgear:nether_star_fragment"]
...
if (Platform.isForge()) {
    ...
    let tagGen = [
        ...
        "copper,tin,aluminum,lead,silver,nickel,bronze,steel,platinum,uranium,iridium,zinc,nether_star"
